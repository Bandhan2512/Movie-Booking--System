    ...
    return (
        <div>
            <form onSubmit={handleSubmit}>
                <Box width={'50%'} padding={6} margin={'auto'} display={'flex'} flexDirection={'column'} boxShadow={'10px 10px 20px #ccc'}>
                    ...
                    <TextField value={inputs.releaseDate} type="date" onChange ={handleChange}name="releaseDate" variant="standard" margin="normal" />
                    ...
                    <Box display={'flex'}>
                            ...
                            <Button onClick={() => {setActors([...actors,actor]); setActor("");}}>Add Movie</Button>
                    </Box>
